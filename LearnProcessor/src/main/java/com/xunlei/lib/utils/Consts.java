...
public class Consts {
    ...
    public static final String WARNING_TIPS = "DO NOT EDIT THIS FILE!!! IT WAS GENERATED BY Jayden.";
    ...
    public static final String PACKAGE_OF_GENERATE_FILE = "com.xunlei.lib.gen";
    ...
    // Custom interface
    private static final String FACADE_PACKAGE = "com.xunlei.applyprocessor";
    ...
    public static final String ANNOTATION_TYPE_PERSON = FACADE_PACKAGE + ".Person";
}